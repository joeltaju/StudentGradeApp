    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var student = await _context.Students
                .FirstOrDefaultAsync(m => m.StudentKey == id);
            if (student == null)
            {
                return NotFound();
            }
...
public async Task<IActionResult> Create([Bind("StudentKey,StudentName,SubjectKey,Grade")] Student student)
{
    ...
    return View(student);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("StudentKey,StudentName,SubjectKey,Grade")] Student student)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!StudentExists(student.StudentKey))
                    {
                        return NotFound();
                    }
                    else
